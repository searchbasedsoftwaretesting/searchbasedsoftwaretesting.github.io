...
\begin{center}
\textbf{Workshop:} \url{http://www.searchbasedsoftwaretesting.org/2020}\\
\textbf{EasyChair:} TBC\\ %\url{https://easychair.org/conferences/?conf=sbst2019}\\
\textbf{Tool Competition:}  TBC\\%\url{http://sbstcontest.dsic.upv.es}\\
